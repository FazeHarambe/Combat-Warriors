...
local killsays = { -- found by cheese
    ...
    ".gg/SgqKcCp8v3 <-- join for cool scripts (!!! real no fake !!!)",
    "ez bozo",
    ...
    "Harambe better than you smh smh smh 😅"
}
...
menu = library.new('<font color="rgb(38, 55, 189)">Harambe</font>.xyz', "HarambeW\\")
local tabs = {
...
do
    ...
    local function update_cfgs()
        all_cfgs = listfiles("HarambeW\\")
        for _, cfg in next, all_cfgs do
            all_cfgs[_] = string.gsub(string.gsub(cfg, "HarambeW\\", ""), ".txt", "")
...
Notification:Notify(
    {Title = "Nofitication", Description = "Harambe Loaded in " .. tick() - t .. "s (seconds)"},
    {OutlineColor = Color3.fromRGB(80, 80, 80), Time = 5, Type = "default"}
)
--/content from harambe\--
--/content from harambe\--
